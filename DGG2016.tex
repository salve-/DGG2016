	...
	\begin{center}
        \begin{tikzpicture}
            \node[anchor=south west,inner sep=0] (image) at (0,0) 	  
			 ...
			 \node[anchor=south west,inner sep=0] at (2.7,5.9) {\textbf{\color{blue} \framebox{Velocity variation $\frac{\Delta v}{v}$} \color{white} + Temperature}};
        \end{tikzpicture}
    \end{center}
\end{frame}
	...
	\begin{center}
        \begin{tikzpicture}
            \node[anchor=south west,inner sep=0] (image) at (0,0) 	  
			 ...
			 \node[anchor=south west,inner sep=0] at (2.7,6.02) {\textbf{\color{blue} Velocity variation $\frac{\Delta v}{v}$ \color{Green} + \framebox{Temperature}}};
        \end{tikzpicture}
    \end{center}
\end{frame}
	...
	\begin{center}
        \begin{tikzpicture}
            \node[anchor=south west,inner sep=0] (image) at (0,0) 	  
			 ...
			 \node[anchor=south west,inner sep=0] at (2.7,6.12) {\textbf{\color{blue} Velocity variation $\frac{\Delta t}{t}$  \color{Green} + Temperature}};
        \end{tikzpicture}
    \end{center}
\end{frame}
...
\begin{frame}{bla}\frametitle{March 2012}
	\begin{center}
        \begin{tikzpicture}
            ...
            \node[anchor=south west,inner sep=0] at (0,6) {\textbf{\color{blue} \framebox{Velocity variation $\frac{\Delta t}{t}$} \color{white} + Deviation (8 receiver pairs) \color{white} + Temperature}};
        \end{tikzpicture}
    \end{center}
\end{frame}
...
\begin{frame}{bla}\frametitle{March 2012}
	\begin{center}
        \begin{tikzpicture}
            ...
            \node[anchor=south west,inner sep=0] at (0,6.1) {\textbf{\color{blue} Velocity variation $\frac{\Delta t}{t}$ \color{orange!40} + \framebox{Deviation (8 receiver pairs)} \color{white} + Temperature}};
        \end{tikzpicture}
    \end{center}
\end{frame}
...
\begin{frame}{bla}\frametitle{March 2012}
	\begin{center}
        \begin{tikzpicture}
            \node[anchor=south west,inner sep=0] (image) at (0,0) 	  
            	 {\includegraphics[width=\linewidth,height=0.95\textheight,keepaspectratio]{Figures/stretch_MAR3.png}};
            \node[anchor=south west,inner sep=0] at (0,6.135) {\textbf{\color{blue} Velocity variation $\frac{\Delta t}{t}$ \color{orange!40} + Deviation (8 receiver pairs) \color{Green} + \framebox{Temperature}}};
        \end{tikzpicture}
    \end{center}
\end{frame}
...
\begin{frame}{bla}\frametitle{March 2012}
	\begin{center}
        \begin{tikzpicture}
            \node[anchor=south west,inner sep=0] (image) at (0,0) 	  
            	 {\includegraphics[width=\linewidth,height=0.95\textheight,keepaspectratio]{Figures/stretch_MAR4.png}};
            \node[anchor=south west,inner sep=0] at (0,6.135) {\textbf{\color{blue} Velocity variation $\frac{\Delta t}{t}$ \color{orange!40} + Deviation (8 receiver pairs) \color{Green} + \framebox{Temperature}}};
        \end{tikzpicture}
    \end{center}
\end{frame}
...
\begin{frame}{bla}\frametitle{March 2012}
	\begin{center}
        \begin{tikzpicture}
            \node[anchor=south west,inner sep=0] (image) at (0, 0) 	  
            	 {\includegraphics[width=\linewidth,height=0.95\textheight,keepaspectratio]{Figures/stretch_MAR4.png}};
%            \node[anchor=south west,inner sep=0] at (2,5) {\textbf{\color{white} Velocity variation $\frac{\Delta v}{v}$ \color{white} + Deviation \color{white} + \framebox{Temperature}}};
			\node[anchor=south west,inner sep=0] at (0,6.135) {\textbf{\color{blue} Velocity variation $\frac{\Delta t}{t}$ \color{orange!40} + Deviation (8 receiver pairs) \color{Green} + \framebox{Temperature}}};
            \node[anchor=south west,inner sep=0] at (2.5,1.7) {\begin{tcolorbox}[colback=green!5,colframe=salve@blue,title=Overall Results,width=7cm]
            		    \begin{small}
							\begin{tabular}{ll}
